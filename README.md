...
| 动态文字 | PE Viewer、安装器和主程序分别已有 128、74、177 条使用原生 `STRINGTABLE`；ExtendedServices、ExtendedTools、UserNotes 分别已迁移 15、25、15 条，HardwareDevices、NetworkTools、OnlineChecks、ToolStatus、Updater、WindowExplorer 合计迁移 15 条，其余动态文字仍使用兼容翻译层 |
| 生成器与源码契约 | 本地测试通过 |
