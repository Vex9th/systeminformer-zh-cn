...
| 动态文字 | PE Viewer、安装器和主程序分别已有 128、74、215 条使用原生 `STRINGTABLE`；ExtendedServices、ExtendedTools、ToolStatus、UserNotes 分别已迁移 15、25、64、15 条，HardwareDevices、NetworkTools、OnlineChecks、Updater、WindowExplorer 合计迁移 13 条。审计当前未发现尚待翻译的已识别动态提示，但大量既有文字仍由兼容翻译层接管，不能据此宣称整体完成 |
| 生成器与源码契约 | 本地测试通过 |
