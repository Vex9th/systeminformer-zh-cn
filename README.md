...
| 动态文字 | PE Viewer 菜单、列表列名、选项和弹窗提示，安装器向导文字，以及主程序的 177 条选项/启动/公共错误提示已使用原生 `STRINGTABLE`；ExtendedServices、ExtendedTools、UserNotes 分别已迁移 15、25、15 条，其余动态文字仍使用兼容翻译层 |
| 生成器与源码契约 | 本地测试通过 |
