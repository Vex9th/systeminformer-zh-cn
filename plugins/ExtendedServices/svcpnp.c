    ...
    )
{
    ...
    {
        PhShowStatus(ParentWindow, PhGetString(PH_AUTO(PhLoadUiString(PluginInstance->DllBase, IDS_ES_FAILED_CHANGE_DEVICE_STATE, NULL))), 0, CM_MapCrToWin32Err(result, ERROR_INVALID_HANDLE_STATE));
        return FALSE;
    }
    ...
    )
{
    ...
    if (result != CR_SUCCESS)
    {
        PhShowStatus(ParentWindow, PhGetString(PH_AUTO(PhLoadUiString(PluginInstance->DllBase, IDS_ES_FAILED_RESTART_DEVICE, NULL))), 0, CM_MapCrToWin32Err(result, ERROR_UNKNOWN_PROPERTY));
        return FALSE;
    }
    ...
    )
{
    ...
    if (result != CR_SUCCESS)
    {
        PhShowStatus(ParentWindow, PhGetString(PH_AUTO(PhLoadUiString(PluginInstance->DllBase, IDS_ES_FAILED_UNINSTALL_DEVICE, NULL))), 0, CM_MapCrToWin32Err(result, ERROR_UNKNOWN_PROPERTY));
        return FALSE;
    }
    ...
    )
{
    ...
    menu = PhCreateEMenu();
    PhInsertEMenuItem(menu, PhCreateEMenuItem(0, 0, PhGetStringOrEmpty(PH_AUTO(PhLoadUiString(PluginInstance->DllBase, IDS_ES_MENU_ENABLE, NULL))), NULL, NULL), ULONG_MAX);
    PhInsertEMenuItem(menu, PhCreateEMenuItem(0, 1, PhGetStringOrEmpty(PH_AUTO(PhLoadUiString(PluginInstance->DllBase, IDS_ES_MENU_DISABLE, NULL))), NULL, NULL), ULONG_MAX);
    PhInsertEMenuItem(menu, PhCreateEMenuItem(0, 2, PhGetStringOrEmpty(PH_AUTO(PhLoadUiString(PluginInstance->DllBase, IDS_ES_MENU_RESTART, NULL))), NULL, NULL), ULONG_MAX);
    PhInsertEMenuItem(menu, PhCreateEMenuItem(0, 3, PhGetStringOrEmpty(PH_AUTO(PhLoadUiString(PluginInstance->DllBase, IDS_ES_MENU_UNINSTALL, NULL))), NULL, NULL), ULONG_MAX);
    PhInsertEMenuItem(menu, PhCreateEMenuSeparator(), ULONG_MAX);
    subMenu = PhCreateEMenuItem(0, 0, PhGetStringOrEmpty(PH_AUTO(PhLoadUiString(PluginInstance->DllBase, IDS_ES_MENU_OPEN_KEY, NULL))), NULL, NULL);
    PhInsertEMenuItem(subMenu, PhCreateEMenuItem(0, 4, PhGetStringOrEmpty(PH_AUTO(PhLoadUiString(PluginInstance->DllBase, IDS_ES_MENU_HARDWARE, NULL))), NULL, NULL), ULONG_MAX);
    PhInsertEMenuItem(subMenu, PhCreateEMenuItem(0, 5, PhGetStringOrEmpty(PH_AUTO(PhLoadUiString(PluginInstance->DllBase, IDS_ES_MENU_SOFTWARE, NULL))), NULL, NULL), ULONG_MAX);
    PhInsertEMenuItem(subMenu, PhCreateEMenuItem(0, 6, PhGetStringOrEmpty(PH_AUTO(PhLoadUiString(PluginInstance->DllBase, IDS_ES_MENU_USER, NULL))), NULL, NULL), ULONG_MAX);
    PhInsertEMenuItem(subMenu, PhCreateEMenuItem(0, 7, PhGetStringOrEmpty(PH_AUTO(PhLoadUiString(PluginInstance->DllBase, IDS_ES_MENU_CONFIG, NULL))), NULL, NULL), ULONG_MAX);
    PhInsertEMenuItem(menu, subMenu, ULONG_MAX);
    PhInsertEMenuItem(menu, PhCreateEMenuSeparator(), ULONG_MAX);
    PhInsertEMenuItem(menu, PhCreateEMenuItem(0, 10, PhGetStringOrEmpty(PH_AUTO(PhLoadUiString(PluginInstance->DllBase, IDS_ES_MENU_PROPERTIES, NULL))), NULL, NULL), ULONG_MAX);
    ...
    case WM_INITDIALOG:
        {
            ...
            PhAddListViewColumn(
                ...
                LVCFMT_LEFT,
                350,
                PhGetStringOrEmpty(PH_AUTO(PhLoadUiString(PluginInstance->DllBase, IDS_ES_COLUMN_PNP_DEVICES, NULL)))
                );
