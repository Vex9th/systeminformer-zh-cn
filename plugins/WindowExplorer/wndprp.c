    ...
    )
{
    ...
    PhAddListViewGroupItem(ListViewHandle, WINDOW_PROPERTIES_CATEGORY_GENERAL, WINDOW_PROPERTIES_INDEX_APPID, PhGetString(PH_AUTO(PhLoadUiString(PluginInstance->DllBase, IDS_WE_WINDOW_PROPERTY_APP_ID, NULL))), NULL);
    PhAddListViewGroupItem(ListViewHandle, WINDOW_PROPERTIES_CATEGORY_GENERAL, WINDOW_PROPERTIES_INDEX_THREAD, PhGetString(PH_AUTO(PhLoadUiString(PluginInstance->DllBase, IDS_WE_WINDOW_PROPERTY_THREAD, NULL))), NULL);
    PhAddListViewGroupItem(ListViewHandle, WINDOW_PROPERTIES_CATEGORY_GENERAL, WINDOW_PROPERTIES_INDEX_RECT, PhGetString(PH_AUTO(PhLoadUiString(PluginInstance->DllBase, IDS_WE_WINDOW_PROPERTY_RECTANGLE, NULL))), NULL);
    PhAddListViewGroupItem(ListViewHandle, WINDOW_PROPERTIES_CATEGORY_GENERAL, WINDOW_PROPERTIES_INDEX_NORMALRECT, PhGetString(PH_AUTO(PhLoadUiString(PluginInstance->DllBase, IDS_WE_WINDOW_PROPERTY_NORMAL_RECTANGLE, NULL))), NULL);
    PhAddListViewGroupItem(ListViewHandle, WINDOW_PROPERTIES_CATEGORY_GENERAL, WINDOW_PROPERTIES_INDEX_CLIENTRECT, PhGetString(PH_AUTO(PhLoadUiString(PluginInstance->DllBase, IDS_WE_WINDOW_PROPERTY_CLIENT_RECTANGLE, NULL))), NULL);
    PhAddListViewGroupItem(ListViewHandle, WINDOW_PROPERTIES_CATEGORY_GENERAL, WINDOW_PROPERTIES_INDEX_INSTANCE, PhGetString(PH_AUTO(PhLoadUiString(PluginInstance->DllBase, IDS_WE_WINDOW_PROPERTY_INSTANCE_HANDLE, NULL))), NULL);
    PhAddListViewGroupItem(ListViewHandle, WINDOW_PROPERTIES_CATEGORY_GENERAL, WINDOW_PROPERTIES_INDEX_MENUHANDLE, PhGetString(PH_AUTO(PhLoadUiString(PluginInstance->DllBase, IDS_WE_WINDOW_PROPERTY_MENU_HANDLE, NULL))), NULL);
    PhAddListViewGroupItem(ListViewHandle, WINDOW_PROPERTIES_CATEGORY_GENERAL, WINDOW_PROPERTIES_INDEX_USERDATA, PhGetString(PH_AUTO(PhLoadUiString(PluginInstance->DllBase, IDS_WE_WINDOW_PROPERTY_USER_DATA, NULL))), NULL);
    PhAddListViewGroupItem(ListViewHandle, WINDOW_PROPERTIES_CATEGORY_GENERAL, WINDOW_PROPERTIES_INDEX_UNICODE, PhGetString(PH_AUTO(PhLoadUiString(PluginInstance->DllBase, IDS_WE_WINDOW_PROPERTY_UNICODE, NULL))), NULL);
    PhAddListViewGroupItem(ListViewHandle, WINDOW_PROPERTIES_CATEGORY_GENERAL, WINDOW_PROPERTIES_INDEX_WNDTEXT, PhGetString(PH_AUTO(PhLoadUiString(PluginInstance->DllBase, IDS_WE_WINDOW_PROPERTY_WINDOW_TEXT, NULL))), NULL);
    PhAddListViewGroupItem(ListViewHandle, WINDOW_PROPERTIES_CATEGORY_GENERAL, WINDOW_PROPERTIES_INDEX_WNDHANDLE, PhGetString(PH_AUTO(PhLoadUiString(PluginInstance->DllBase, IDS_WE_WINDOW_PROPERTY_WINDOW_HANDLE, NULL))), NULL);
    PhAddListViewGroupItem(ListViewHandle, WINDOW_PROPERTIES_CATEGORY_GENERAL, WINDOW_PROPERTIES_INDEX_WNDUNIQID, PhGetString(PH_AUTO(PhLoadUiString(PluginInstance->DllBase, IDS_WE_WINDOW_PROPERTY_WINDOW_UNIQUE_ID, NULL))), NULL);
    PhAddListViewGroupItem(ListViewHandle, WINDOW_PROPERTIES_CATEGORY_GENERAL, WINDOW_PROPERTIES_INDEX_WNDMSGONLY, PhGetString(PH_AUTO(PhLoadUiString(PluginInstance->DllBase, IDS_WE_WINDOW_PROPERTY_MESSAGE_ONLY, NULL))), NULL);
    PhAddListViewGroupItem(ListViewHandle, WINDOW_PROPERTIES_CATEGORY_GENERAL, WINDOW_PROPERTIES_INDEX_WNDEXTRA, PhGetString(PH_AUTO(PhLoadUiString(PluginInstance->DllBase, IDS_WE_WINDOW_PROPERTY_EXTRA_BYTES, NULL))), NULL);
    PhAddListViewGroupItem(ListViewHandle, WINDOW_PROPERTIES_CATEGORY_GENERAL, WINDOW_PROPERTIES_INDEX_WNDPROC, PhGetString(PH_AUTO(PhLoadUiString(PluginInstance->DllBase, IDS_WE_WINDOW_PROPERTY_PROCEDURE, NULL))), NULL);
    PhAddListViewGroupItem(ListViewHandle, WINDOW_PROPERTIES_CATEGORY_GENERAL, WINDOW_PROPERTIES_INDEX_DLGPROC, PhGetString(PH_AUTO(PhLoadUiString(PluginInstance->DllBase, IDS_WE_WINDOW_PROPERTY_DIALOG_PROCEDURE, NULL))), NULL);
    PhAddListViewGroupItem(ListViewHandle, WINDOW_PROPERTIES_CATEGORY_GENERAL, WINDOW_PROPERTIES_INDEX_DLGCTLID, PhGetString(PH_AUTO(PhLoadUiString(PluginInstance->DllBase, IDS_WE_WINDOW_PROPERTY_DIALOG_CONTROL_ID, NULL))), NULL);
    PhAddListViewGroupItem(ListViewHandle, WINDOW_PROPERTIES_CATEGORY_GENERAL, WINDOW_PROPERTIES_INDEX_FONTNAME, PhGetString(PH_AUTO(PhLoadUiString(PluginInstance->DllBase, IDS_WE_WINDOW_PROPERTY_FONT, NULL))), NULL);
    PhAddListViewGroupItem(ListViewHandle, WINDOW_PROPERTIES_CATEGORY_GENERAL, WINDOW_PROPERTIES_INDEX_STYLES, PhGetString(PH_AUTO(PhLoadUiString(PluginInstance->DllBase, IDS_WE_WINDOW_PROPERTY_STYLES, NULL))), NULL);
    PhAddListViewGroupItem(ListViewHandle, WINDOW_PROPERTIES_CATEGORY_GENERAL, WINDOW_PROPERTIES_INDEX_EXSTYLES, PhGetString(PH_AUTO(PhLoadUiString(PluginInstance->DllBase, IDS_WE_WINDOW_PROPERTY_EXTENDED_STYLES, NULL))), NULL);
    PhAddListViewGroupItem(ListViewHandle, WINDOW_PROPERTIES_CATEGORY_GENERAL, WINDOW_PROPERTIES_INDEX_AUTOMATION, PhGetString(PH_AUTO(PhLoadUiString(PluginInstance->DllBase, IDS_WE_WINDOW_PROPERTY_AUTOMATION_SERVER, NULL))), NULL);
    PhAddListViewGroupItem(ListViewHandle, WINDOW_PROPERTIES_CATEGORY_GENERAL, WINDOW_PROPERTIES_INDEX_DPICONTEXT, PhGetString(PH_AUTO(PhLoadUiString(PluginInstance->DllBase, IDS_WE_WINDOW_PROPERTY_DPI_CONTEXT, NULL))), NULL);
    PhAddListViewGroupItem(ListViewHandle, WINDOW_PROPERTIES_CATEGORY_GENERAL, WINDOW_PROPERTIES_INDEX_MONITOR, PhGetString(PH_AUTO(PhLoadUiString(PluginInstance->DllBase, IDS_WE_WINDOW_PROPERTY_MONITOR, NULL))), NULL);
    PhAddListViewGroupItem(ListViewHandle, WINDOW_PROPERTIES_CATEGORY_GENERAL, WINDOW_PROPERTIES_INDEX_TOPLEVEL, PhGetString(PH_AUTO(PhLoadUiString(PluginInstance->DllBase, IDS_WE_WINDOW_PROPERTY_TOP_LEVEL, NULL))), NULL);
    PhAddListViewGroupItem(ListViewHandle, WINDOW_PROPERTIES_CATEGORY_GENERAL, WINDOW_PROPERTIES_INDEX_CLOAKED, PhGetString(PH_AUTO(PhLoadUiString(PluginInstance->DllBase, IDS_WE_WINDOW_PROPERTY_CLOAKED, NULL))), NULL);
    PhAddListViewGroupItem(ListViewHandle, WINDOW_PROPERTIES_CATEGORY_GENERAL, WINDOW_PROPERTIES_INDEX_IAMID, PhGetString(PH_AUTO(PhLoadUiString(PluginInstance->DllBase, IDS_WE_WINDOW_PROPERTY_BAND, NULL))), NULL);
    PhAddListViewGroupItem(ListViewHandle, WINDOW_PROPERTIES_CATEGORY_GENERAL, WINDOW_PROPERTIES_INDEX_IMEWND, PhGetString(PH_AUTO(PhLoadUiString(PluginInstance->DllBase, IDS_WE_WINDOW_PROPERTY_IME_WINDOW, NULL))), NULL);
    PhAddListViewGroupItem(ListViewHandle, WINDOW_PROPERTIES_CATEGORY_GENERAL, WINDOW_PROPERTIES_INDEX_D3DKMT_EXCLUSIVE, PhGetString(PH_AUTO(PhLoadUiString(PluginInstance->DllBase, IDS_WE_WINDOW_PROPERTY_EXCLUSIVE_OWNERSHIP, NULL))), NULL);

    PhAddListViewGroupItem(ListViewHandle, WINDOW_PROPERTIES_CATEGORY_CLASS, WINDOW_PROPERTIES_INDEX_CLASS_NAME, PhGetString(PH_AUTO(PhLoadUiString(PluginInstance->DllBase, IDS_WE_WINDOW_PROPERTY_NAME, NULL))), NULL);
    PhAddListViewGroupItem(ListViewHandle, WINDOW_PROPERTIES_CATEGORY_CLASS, WINDOW_PROPERTIES_INDEX_CLASS_BASENAME, PhGetString(PH_AUTO(PhLoadUiString(PluginInstance->DllBase, IDS_WE_WINDOW_PROPERTY_BASE_NAME, NULL))), NULL);
    PhAddListViewGroupItem(ListViewHandle, WINDOW_PROPERTIES_CATEGORY_CLASS, WINDOW_PROPERTIES_INDEX_CLASS_ATOM, PhGetString(PH_AUTO(PhLoadUiString(PluginInstance->DllBase, IDS_WE_WINDOW_PROPERTY_ATOM, NULL))), NULL);
    PhAddListViewGroupItem(ListViewHandle, WINDOW_PROPERTIES_CATEGORY_CLASS, WINDOW_PROPERTIES_INDEX_CLASS_STYLES, PhGetString(PH_AUTO(PhLoadUiString(PluginInstance->DllBase, IDS_WE_WINDOW_PROPERTY_STYLES, NULL))), NULL);
    PhAddListViewGroupItem(ListViewHandle, WINDOW_PROPERTIES_CATEGORY_CLASS, WINDOW_PROPERTIES_INDEX_CLASS_INSTANCE, PhGetString(PH_AUTO(PhLoadUiString(PluginInstance->DllBase, IDS_WE_WINDOW_PROPERTY_INSTANCE_HANDLE, NULL))), NULL);
    PhAddListViewGroupItem(ListViewHandle, WINDOW_PROPERTIES_CATEGORY_CLASS, WINDOW_PROPERTIES_INDEX_CLASS_LARGEICON, PhGetString(PH_AUTO(PhLoadUiString(PluginInstance->DllBase, IDS_WE_WINDOW_PROPERTY_LARGE_ICON_HANDLE, NULL))), NULL);
    PhAddListViewGroupItem(ListViewHandle, WINDOW_PROPERTIES_CATEGORY_CLASS, WINDOW_PROPERTIES_INDEX_CLASS_SMALLICON, PhGetString(PH_AUTO(PhLoadUiString(PluginInstance->DllBase, IDS_WE_WINDOW_PROPERTY_SMALL_ICON_HANDLE, NULL))), NULL);
    PhAddListViewGroupItem(ListViewHandle, WINDOW_PROPERTIES_CATEGORY_CLASS, WINDOW_PROPERTIES_INDEX_CLASS_CURSOR, PhGetString(PH_AUTO(PhLoadUiString(PluginInstance->DllBase, IDS_WE_WINDOW_PROPERTY_CURSOR_HANDLE, NULL))), NULL);
    PhAddListViewGroupItem(ListViewHandle, WINDOW_PROPERTIES_CATEGORY_CLASS, WINDOW_PROPERTIES_INDEX_CLASS_BACKBRUSH, PhGetString(PH_AUTO(PhLoadUiString(PluginInstance->DllBase, IDS_WE_WINDOW_PROPERTY_BACKGROUND_BRUSH, NULL))), NULL);
    PhAddListViewGroupItem(ListViewHandle, WINDOW_PROPERTIES_CATEGORY_CLASS, WINDOW_PROPERTIES_INDEX_CLASS_MENUNAME, PhGetString(PH_AUTO(PhLoadUiString(PluginInstance->DllBase, IDS_WE_WINDOW_PROPERTY_MENU_NAME, NULL))), NULL);
    PhAddListViewGroupItem(ListViewHandle, WINDOW_PROPERTIES_CATEGORY_CLASS, WINDOW_PROPERTIES_INDEX_CLASS_WNDEXTRA, PhGetString(PH_AUTO(PhLoadUiString(PluginInstance->DllBase, IDS_WE_WINDOW_PROPERTY_EXTRA_BYTES, NULL))), NULL);
    PhAddListViewGroupItem(ListViewHandle, WINDOW_PROPERTIES_CATEGORY_CLASS, WINDOW_PROPERTIES_INDEX_CLASS_WNDPROC, PhGetString(PH_AUTO(PhLoadUiString(PluginInstance->DllBase, IDS_WE_WINDOW_PROPERTY_PROCEDURE, NULL))), NULL);
    PhAddListViewGroupItem(ListViewHandle, WINDOW_PROPERTIES_CATEGORY_CLASS, WINDOW_PROPERTIES_INDEX_CLASS_DROPSHADOW, PhGetString(PH_AUTO(PhLoadUiString(PluginInstance->DllBase, IDS_WE_WINDOW_PROPERTY_DROP_SHADOW, NULL))), NULL);
    PhAddListViewGroupItem(ListViewHandle, WINDOW_PROPERTIES_CATEGORY_CLASS, WINDOW_PROPERTIES_INDEX_CLASS_SAVEBITS, PhGetString(PH_AUTO(PhLoadUiString(PluginInstance->DllBase, IDS_WE_WINDOW_PROPERTY_SAVE_BITS, NULL))), NULL);
}
