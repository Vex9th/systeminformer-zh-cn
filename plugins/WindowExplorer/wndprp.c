    ...
    )
{
    ...
    PhAddListViewGroupItem(
        ...
        PhGetString(PH_AUTO(PhLoadUiString(
            PluginInstance->DllBase,
            IDS_WE_WINDOW_PROPERTY_RECTANGLE,
            NULL
            ))),
        NULL
        );
    PhAddListViewGroupItem(
        ...
        PhGetString(PH_AUTO(PhLoadUiString(
            PluginInstance->DllBase,
            IDS_WE_WINDOW_PROPERTY_NORMAL_RECTANGLE,
            NULL
            ))),
        NULL
        );
    PhAddListViewGroupItem(
        ...
        PhGetString(PH_AUTO(PhLoadUiString(
            PluginInstance->DllBase,
            IDS_WE_WINDOW_PROPERTY_CLIENT_RECTANGLE,
            NULL
            ))),
        NULL
        );
    PhAddListViewGroupItem(
        ...
        PhGetString(PH_AUTO(PhLoadUiString(
            PluginInstance->DllBase,
            IDS_WE_WINDOW_PROPERTY_INSTANCE_HANDLE,
            NULL
            ))),
        NULL
        );
    PhAddListViewGroupItem(
        ...
        PhGetString(PH_AUTO(PhLoadUiString(
            PluginInstance->DllBase,
            IDS_WE_WINDOW_PROPERTY_MENU_HANDLE,
            NULL
            ))),
        NULL
        );
    PhAddListViewGroupItem(
        ...
        PhGetString(PH_AUTO(PhLoadUiString(
            PluginInstance->DllBase,
            IDS_WE_WINDOW_PROPERTY_USER_DATA,
            NULL
            ))),
        NULL
        );
    PhAddListViewGroupItem(
        ...
        PhGetString(PH_AUTO(PhLoadUiString(
            PluginInstance->DllBase,
            IDS_WE_WINDOW_PROPERTY_UNICODE,
            NULL
            ))),
        NULL
        );
    PhAddListViewGroupItem(
        ...
        PhGetString(PH_AUTO(PhLoadUiString(
            PluginInstance->DllBase,
            IDS_WE_WINDOW_PROPERTY_WINDOW_TEXT,
            NULL
            ))),
        NULL
        );
    PhAddListViewGroupItem(
        ...
        PhGetString(PH_AUTO(PhLoadUiString(
            PluginInstance->DllBase,
            IDS_WE_WINDOW_PROPERTY_WINDOW_HANDLE,
            NULL
            ))),
        NULL
        );
    PhAddListViewGroupItem(
        ...
        PhGetString(PH_AUTO(PhLoadUiString(
            PluginInstance->DllBase,
            IDS_WE_WINDOW_PROPERTY_WINDOW_UNIQUE_ID,
            NULL
            ))),
        NULL
        );
    PhAddListViewGroupItem(
        ...
        PhGetString(PH_AUTO(PhLoadUiString(
            PluginInstance->DllBase,
            IDS_WE_WINDOW_PROPERTY_MESSAGE_ONLY,
            NULL
            ))),
        NULL
        );
    PhAddListViewGroupItem(
        ...
        PhGetString(PH_AUTO(PhLoadUiString(
            PluginInstance->DllBase,
            IDS_WE_WINDOW_PROPERTY_EXTRA_BYTES,
            NULL
            ))),
        NULL
        );
    PhAddListViewGroupItem(
        ...
        PhGetString(PH_AUTO(PhLoadUiString(
            PluginInstance->DllBase,
            IDS_WE_WINDOW_PROPERTY_PROCEDURE,
            NULL
            ))),
        NULL
        );
    PhAddListViewGroupItem(
        ...
        PhGetString(PH_AUTO(PhLoadUiString(
            PluginInstance->DllBase,
            IDS_WE_WINDOW_PROPERTY_DIALOG_PROCEDURE,
            NULL
            ))),
        NULL
        );
    PhAddListViewGroupItem(
        ...
        PhGetString(PH_AUTO(PhLoadUiString(
            PluginInstance->DllBase,
            IDS_WE_WINDOW_PROPERTY_DIALOG_CONTROL_ID,
            NULL
            ))),
        NULL
        );
    ...
    PhAddListViewGroupItem(
        ...
        PhGetString(PH_AUTO(PhLoadUiString(
            PluginInstance->DllBase,
            IDS_WE_WINDOW_PROPERTY_EXTENDED_STYLES,
            NULL
            ))),
        NULL
        );
    PhAddListViewGroupItem(
        ...
        PhGetString(PH_AUTO(PhLoadUiString(
            PluginInstance->DllBase,
            IDS_WE_WINDOW_PROPERTY_AUTOMATION_SERVER,
            NULL
            ))),
        NULL
        );
    PhAddListViewGroupItem(
        ...
        PhGetString(PH_AUTO(PhLoadUiString(
            PluginInstance->DllBase,
            IDS_WE_WINDOW_PROPERTY_DPI_CONTEXT,
            NULL
            ))),
        NULL
        );
    PhAddListViewGroupItem(
        ...
        PhGetString(PH_AUTO(PhLoadUiString(
            PluginInstance->DllBase,
            IDS_WE_WINDOW_PROPERTY_MONITOR,
            NULL
            ))),
        NULL
        );
    PhAddListViewGroupItem(
        ...
        PhGetString(PH_AUTO(PhLoadUiString(
            PluginInstance->DllBase,
            IDS_WE_WINDOW_PROPERTY_TOP_LEVEL,
            NULL
            ))),
        NULL
        );
    PhAddListViewGroupItem(
        ...
        PhGetString(PH_AUTO(PhLoadUiString(
            PluginInstance->DllBase,
            IDS_WE_WINDOW_PROPERTY_CLOAKED,
            NULL
            ))),
        NULL
        );
    ...
    PhAddListViewGroupItem(
        ...
        PhGetString(PH_AUTO(PhLoadUiString(
            PluginInstance->DllBase,
            IDS_WE_WINDOW_PROPERTY_IME_WINDOW,
            NULL
            ))),
        NULL
        );
    PhAddListViewGroupItem(
        ...
        PhGetString(PH_AUTO(PhLoadUiString(
            PluginInstance->DllBase,
            IDS_WE_WINDOW_PROPERTY_EXCLUSIVE_OWNERSHIP,
            NULL
            ))),
        NULL
        );
    ...
    PhAddListViewGroupItem(
        ...
        PhGetString(PH_AUTO(PhLoadUiString(
            PluginInstance->DllBase,
            IDS_WE_WINDOW_PROPERTY_BASE_NAME,
            NULL
            ))),
        NULL
        );
    ...
    PhAddListViewGroupItem(
        ...
        PhGetString(PH_AUTO(PhLoadUiString(
            PluginInstance->DllBase,
            IDS_WE_WINDOW_PROPERTY_LARGE_ICON_HANDLE,
            NULL
            ))),
        NULL
        );
    PhAddListViewGroupItem(
        ...
        PhGetString(PH_AUTO(PhLoadUiString(
            PluginInstance->DllBase,
            IDS_WE_WINDOW_PROPERTY_SMALL_ICON_HANDLE,
            NULL
            ))),
        NULL
        );
    PhAddListViewGroupItem(
        ...
        PhGetString(PH_AUTO(PhLoadUiString(
            PluginInstance->DllBase,
            IDS_WE_WINDOW_PROPERTY_CURSOR_HANDLE,
            NULL
            ))),
        NULL
        );
    PhAddListViewGroupItem(
        ...
        PhGetString(PH_AUTO(PhLoadUiString(
            PluginInstance->DllBase,
            IDS_WE_WINDOW_PROPERTY_BACKGROUND_BRUSH,
            NULL
            ))),
        NULL
        );
    PhAddListViewGroupItem(
        ...
        PhGetString(PH_AUTO(PhLoadUiString(
            PluginInstance->DllBase,
            IDS_WE_WINDOW_PROPERTY_MENU_NAME,
            NULL
            ))),
        NULL
        );
    ...
    PhAddListViewGroupItem(
        ...
        PhGetString(PH_AUTO(PhLoadUiString(
            PluginInstance->DllBase,
            IDS_WE_WINDOW_PROPERTY_DROP_SHADOW,
            NULL
            ))),
        NULL
        );
    PhAddListViewGroupItem(
        ...
        PhGetString(PH_AUTO(PhLoadUiString(
            PluginInstance->DllBase,
            IDS_WE_WINDOW_PROPERTY_SAVE_BITS,
            NULL
            ))),
        NULL
        );
