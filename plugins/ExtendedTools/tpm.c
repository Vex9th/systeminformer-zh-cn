    ...
    case WM_INITDIALOG:
        {
            ...
            PhAddListViewColumn(context->ListViewHandle, 0, 0, 0, LVCFMT_LEFT, 80, EtGetUiString(IDS_ET_INDEX, L"Index"));
            PhAddListViewColumn(context->ListViewHandle, 1, 1, 1, LVCFMT_LEFT, 80, EtGetUiString(IDS_ET_TPM_COLUMN_DATA_SIZE, L"Data size"));
            PhAddListViewColumn(context->ListViewHandle, 2, 2, 2, LVCFMT_LEFT, 85, EtGetUiString(IDS_ET_TPM_COLUMN_OWNER_RIGHTS, L"Owner rights"));
            PhAddListViewColumn(context->ListViewHandle, 3, 3, 3, LVCFMT_LEFT, 85, EtGetUiString(IDS_ET_TPM_COLUMN_AUTH_RIGHTS, L"Auth rights"));
            PhAddListViewColumn(context->ListViewHandle, 4, 4, 4, LVCFMT_LEFT, 85, EtGetUiString(IDS_ET_TPM_COLUMN_PLATFORM_RIGHTS, L"Platform rights"));
            PhAddListViewColumn(context->ListViewHandle, 5, 5, 5, LVCFMT_LEFT, 400, EtGetUiString(IDS_ET_FIRMWARE_COLUMN_ATTRIBUTES, L"Attributes"));
    ...
    case WM_CONTEXTMENU:
        {
            if ((HWND)wParam == context->ListViewHandle)
            {
                ...
                {
                    menu = PhCreateEMenu();
                    PhInsertEMenuItem(menu, PhCreateEMenuItem(0, 1, EtGetUiString(IDS_ET_MENU_EDIT, L"&Edit"), NULL, NULL), ULONG_MAX);
