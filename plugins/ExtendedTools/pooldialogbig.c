    ...
    case WM_INITDIALOG:
        {
            ...
            PhAddListViewColumn(context->ListViewHandle, 0, 0, 0, LVCFMT_LEFT, 150, EtGetUiString(IDS_ET_COLUMN_ADDRESS, L"Address"));
            PhAddListViewColumn(context->ListViewHandle, 1, 1, 1, LVCFMT_LEFT, 100, EtGetUiString(IDS_ET_COLUMN_SIZE, L"Size"));
            PhAddListViewColumn(context->ListViewHandle, 2, 2, 2, LVCFMT_LEFT, 100, EtGetUiString(IDS_ET_POOL_COLUMN_NONPAGED, L"NonPaged"));
