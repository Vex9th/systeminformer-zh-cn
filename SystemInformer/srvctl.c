    ...
    case WM_INITDIALOG:
        {
            ...
            PhAddListViewColumn(context->ListViewHandle, 1, 1, 1, LVCFMT_LEFT, 220, PhGetApplicationUiString(IDS_PH_LISTVIEW_DISPLAY_NAME));
            PhAddListViewColumn(context->ListViewHandle, 2, 2, 2, LVCFMT_LEFT, 220, PhGetApplicationUiString(IDS_PH_FILE_NAME));
    ...
    case WM_CONTEXTMENU:
        {
            if ((HWND)wParam == context->ListViewHandle)
            {
                ...
                {
                    menu = PhCreateEMenu();
                    PhInsertEMenuItem(menu, PhCreateEMenuItem(0, 1, PhGetApplicationUiString(IDS_PH_MENU_GO_TO_SERVICE), NULL, NULL), ULONG_MAX);
