    ...
    case WM_INITDIALOG:
        {
            ...
            PhAddListViewColumn(context->ListViewHandle, 0, 0, 0, LVCFMT_LEFT, 140, PhGetApplicationUiString(IDS_PH_TOKEN_TYPE));
            PhAddListViewColumn(context->ListViewHandle, 1, 1, 1, LVCFMT_LEFT, 100, PhGetApplicationUiString(IDS_PH_HANDLE_COUNT));
