    ...
    )
{
    ...
    // Default columns
    PhAddTreeNewColumn(Context->TreeNewHandle, PHMOTLC_NAME, TRUE, PhGetApplicationUiString(IDS_PH_TOKEN_NAME), 100, PH_ALIGN_LEFT, -2, 0);
    PhAddTreeNewColumn(Context->TreeNewHandle, PHMOTLC_BASEADDRESS, TRUE, PhGetApplicationUiString(IDS_PH_TREENEW_BASE_ADDRESS), 80, PH_ALIGN_LEFT | (enableMonospaceFont ? PH_ALIGN_MONOSPACE_FONT : 0), 0, 0);
    PhAddTreeNewColumnEx(Context->TreeNewHandle, PHMOTLC_SIZE, TRUE, PhGetApplicationUiString(IDS_PH_HANDLE_SIZE), 60, PH_ALIGN_RIGHT, 1, DT_RIGHT, TRUE);
    PhAddTreeNewColumn(Context->TreeNewHandle, PHMOTLC_DESCRIPTION, TRUE, PhGetApplicationUiString(IDS_PH_LISTVIEW_DESCRIPTION), 160, PH_ALIGN_LEFT, 2, 0);
    // Available columns
    PhAddTreeNewColumn(Context->TreeNewHandle, PHMOTLC_COMPANYNAME, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_COMPANY_NAME), 180, PH_ALIGN_LEFT, ULONG_MAX, 0);
    PhAddTreeNewColumn(Context->TreeNewHandle, PHMOTLC_VERSION, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_VERSION), 100, PH_ALIGN_LEFT, ULONG_MAX, 0);
    PhAddTreeNewColumn(Context->TreeNewHandle, PHMOTLC_FILENAME, FALSE, PhGetApplicationUiString(IDS_PH_FILE_NAME), 180, PH_ALIGN_LEFT, ULONG_MAX, DT_PATH_ELLIPSIS);
    PhAddTreeNewColumn(Context->TreeNewHandle, PHMOTLC_TYPE, FALSE, PhGetApplicationUiString(IDS_PH_TOKEN_TYPE), 80, PH_ALIGN_LEFT, ULONG_MAX, 0);
    PhAddTreeNewColumnEx(Context->TreeNewHandle, PHMOTLC_LOADCOUNT, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_LOAD_COUNT), 40, PH_ALIGN_RIGHT, ULONG_MAX, DT_RIGHT, TRUE);
    PhAddTreeNewColumn(Context->TreeNewHandle, PHMOTLC_VERIFICATIONSTATUS, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_VERIFICATION_STATUS), 70, PH_ALIGN_LEFT, ULONG_MAX, 0);
    PhAddTreeNewColumn(Context->TreeNewHandle, PHMOTLC_VERIFIEDSIGNER, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_VERIFIED_SIGNER), 100, PH_ALIGN_LEFT, ULONG_MAX, 0);
    PhAddTreeNewColumnEx(Context->TreeNewHandle, PHMOTLC_ASLR, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_ASLR), 50, PH_ALIGN_LEFT, ULONG_MAX, 0, TRUE);
    PhAddTreeNewColumnEx(Context->TreeNewHandle, PHMOTLC_TIMESTAMP, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_TIME_STAMP), 100, PH_ALIGN_LEFT, ULONG_MAX, 0, TRUE);
    PhAddTreeNewColumnEx(Context->TreeNewHandle, PHMOTLC_CFGUARD, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_CF_GUARD), 70, PH_ALIGN_LEFT, ULONG_MAX, 0, TRUE);
    PhAddTreeNewColumnEx(Context->TreeNewHandle, PHMOTLC_LOADTIME, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_LOAD_TIME), 100, PH_ALIGN_LEFT, ULONG_MAX, 0, TRUE);
    PhAddTreeNewColumn(Context->TreeNewHandle, PHMOTLC_LOADREASON, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_LOAD_REASON), 80, PH_ALIGN_LEFT, ULONG_MAX, 0);
    PhAddTreeNewColumnEx(Context->TreeNewHandle, PHMOTLC_FILEMODIFIEDTIME, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_FILE_MODIFIED_TIME), 140, PH_ALIGN_LEFT, ULONG_MAX, 0, TRUE);
    PhAddTreeNewColumnEx(Context->TreeNewHandle, PHMOTLC_FILESIZE, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_FILE_SIZE), 70, PH_ALIGN_RIGHT, ULONG_MAX, DT_RIGHT, TRUE);
    PhAddTreeNewColumnEx(Context->TreeNewHandle, PHMOTLC_ENTRYPOINT, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_ENTRY_POINT), 70, PH_ALIGN_RIGHT | (enableMonospaceFont ? PH_ALIGN_MONOSPACE_FONT : 0), ULONG_MAX, DT_RIGHT, TRUE);
    PhAddTreeNewColumnEx(Context->TreeNewHandle, PHMOTLC_PARENTBASEADDRESS, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_PARENT_BASE_ADDRESS), 70, PH_ALIGN_RIGHT | (enableMonospaceFont ? PH_ALIGN_MONOSPACE_FONT : 0), ULONG_MAX, DT_RIGHT, TRUE);
    PhAddTreeNewColumnEx(Context->TreeNewHandle, PHMOTLC_CET, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_CET), 50, PH_ALIGN_LEFT, ULONG_MAX, 0, TRUE);
    PhAddTreeNewColumnEx(Context->TreeNewHandle, PHMOTLC_COHERENCY, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_IMAGE_COHERENCY), 70, PH_ALIGN_RIGHT, ULONG_MAX, DT_RIGHT, TRUE);
    PhAddTreeNewColumnEx2(Context->TreeNewHandle, PHMOTLC_TIMELINE, FALSE, PhGetApplicationUiString(IDS_PH_TIMELINE), 100, PH_ALIGN_LEFT, ULONG_MAX, 0, TN_COLUMN_FLAG_CUSTOMDRAW | TN_COLUMN_FLAG_SORTDESCENDING);
    PhAddTreeNewColumn(Context->TreeNewHandle, PHMOTLC_ORIGINALNAME, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_ORIGINAL_NAME), 200, PH_ALIGN_LEFT, ULONG_MAX, DT_PATH_ELLIPSIS);
    PhAddTreeNewColumn(Context->TreeNewHandle, PHMOTLC_SERVICE, FALSE, PhGetApplicationUiString(IDS_PH_LOGON_SERVICE), 80, PH_ALIGN_LEFT, ULONG_MAX, 0);
    PhAddTreeNewColumn(Context->TreeNewHandle, PHMOTLC_ENCLAVE_TYPE, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_ENCLAVE_TYPE), 40, PH_ALIGN_LEFT, ULONG_MAX, 0);
    PhAddTreeNewColumnEx(Context->TreeNewHandle, PHMOTLC_ENCLAVE_BASE_ADDRESS, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_ENCLAVE_BASE_ADDRESS), 80, PH_ALIGN_LEFT | (enableMonospaceFont ? PH_ALIGN_MONOSPACE_FONT : 0), ULONG_MAX, DT_RIGHT, TRUE);
    PhAddTreeNewColumnEx(Context->TreeNewHandle, PHMOTLC_ENCLAVE_SIZE, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_ENCLAVE_SIZE), 80, PH_ALIGN_RIGHT, ULONG_MAX, DT_RIGHT, TRUE);
    PhAddTreeNewColumnEx(Context->TreeNewHandle, PHMOTLC_ARCHITECTURE, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_ARCHITECTURE), 80, PH_ALIGN_LEFT, ULONG_MAX, DT_RIGHT, TRUE);
