    ...
    case MainTabPageInitializeSectionMenuItems:
        {
            ...
            menu = PhCreateEMenuItem(0, 0, PhGetApplicationUiString(IDS_PH_LOGON_NETWORK), NULL, NULL);
            PhInsertEMenuItem(menuInfo->Menu, menu, menuInfo->StartIndex);

            PhInsertEMenuItem(menu, PhCreateEMenuItem(0, ID_VIEW_HIDEWAITINGCONNECTIONS, PhGetApplicationUiString(IDS_PH_MENU_HIDE_WAITING_CONNECTIONS), NULL, NULL), ULONG_MAX);
    ...
    )
{
    ...
    if (numberOfNetworkItems != 0)
    {
        ...
        menu = PhCreateEMenu();
        PhInsertEMenuItem(menu, PhCreateEMenuItem(0, ID_NETWORK_GOTOPROCESS, PhGetApplicationUiString(IDS_PH_MENU_GO_TO_PROCESS_SHORTCUT), NULL, NULL), ULONG_MAX);
        PhInsertEMenuItem(menu, PhCreateEMenuItem(0, ID_NETWORK_GOTOSERVICE, PhGetApplicationUiString(IDS_PH_MENU_GO_TO_SERVICE), NULL, NULL), ULONG_MAX);
        PhInsertEMenuItem(menu, PhCreateEMenuSeparator(), ULONG_MAX);
        PhInsertEMenuItem(menu, PhCreateEMenuItem(0, ID_NETWORK_CLOSE, PhGetApplicationUiString(IDS_PH_MENU_CLOSE), NULL, NULL), ULONG_MAX);
        PhInsertEMenuItem(menu, PhCreateEMenuSeparator(), ULONG_MAX);
        PhInsertEMenuItem(menu, PhCreateEMenuItem(0, ID_NETWORK_COPY, PhGetApplicationUiString(IDS_PH_MENU_COPY_SHORTCUT), NULL, NULL), ULONG_MAX);
