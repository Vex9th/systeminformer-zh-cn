    ...
    case TreeNewContextMenu:
        {
            ...
            menu = PhCreateEMenu();
            PhInsertEMenuItem(menu, gotoProcess = PhCreateEMenuItem(0, 1, PhGetApplicationUiString(IDS_PH_MENU_GO_TO_PROCESS_ELLIPSIS), NULL, NULL), ULONG_MAX);
            PhInsertEMenuItem(menu, gotoThread = PhCreateEMenuItem(0, 2, PhGetApplicationUiString(IDS_PH_MENU_GO_TO_THREAD_ELLIPSIS), NULL, NULL), ULONG_MAX);
            PhInsertEMenuItem(menu, PhCreateEMenuSeparator(), ULONG_MAX);
            PhInsertEMenuItem(menu, hideUserFrames = PhCreateEMenuItem(0, 3, PhGetApplicationUiString(IDS_PH_MENU_EXPAND_ALL_PLAIN), NULL, NULL), ULONG_MAX);
            PhInsertEMenuItem(menu, hideUserFrames = PhCreateEMenuItem(0, 4, PhGetApplicationUiString(IDS_PH_MENU_COLLAPSE_ALL_PLAIN), NULL, NULL), ULONG_MAX);
            PhInsertEMenuItem(menu, PhCreateEMenuSeparator(), ULONG_MAX);
            PhInsertEMenuItem(menu, hideUserFrames = PhCreateEMenuItem(0, 5, PhGetApplicationUiString(IDS_PH_MENU_HIDE_USER_FRAMES), NULL, NULL), ULONG_MAX);
            PhInsertEMenuItem(menu, hideSystemFrames = PhCreateEMenuItem(0, 6, PhGetApplicationUiString(IDS_PH_MENU_HIDE_SYSTEM_FRAMES), NULL, NULL), ULONG_MAX);
            PhInsertEMenuItem(menu, hideInlineFrames = PhCreateEMenuItem(0, 7, PhGetApplicationUiString(IDS_PH_MENU_HIDE_INLINE_FRAMES), NULL, NULL), ULONG_MAX);
            PhInsertEMenuItem(menu, PhCreateEMenuSeparator(), ULONG_MAX);
            PhInsertEMenuItem(menu, highlightUserFrames = PhCreateEMenuItem(0, 8, PhGetApplicationUiString(IDS_PH_MENU_HIGHLIGHT_USER_FRAMES), NULL, NULL), ULONG_MAX);
            PhInsertEMenuItem(menu, highlightSystemFrames = PhCreateEMenuItem(0, 9, PhGetApplicationUiString(IDS_PH_MENU_HIGHLIGHT_SYSTEM_FRAMES), NULL, NULL), ULONG_MAX);
            PhInsertEMenuItem(menu, highlightInlineFrames = PhCreateEMenuItem(0, 10, PhGetApplicationUiString(IDS_PH_MENU_HIGHLIGHT_INLINE_FRAMES), NULL, NULL), ULONG_MAX);
            PhInsertEMenuItem(menu, PhCreateEMenuSeparator(), ULONG_MAX);
            PhInsertEMenuItem(menu, PhCreateEMenuItem(0, 100, PhGetApplicationUiString(IDS_PH_SEARCH_COPY), NULL, NULL), ULONG_MAX);
    ...
    )
{
    ...
    PhAddTreeNewColumn(Context->TreeNewHandle, PH_THREAD_STACKS_COLUMN_SYMBOL, TRUE, PhGetApplicationUiString(IDS_PH_LISTVIEW_SYMBOL), 250, PH_ALIGN_LEFT, 0, 0);
    ...
    PhAddTreeNewColumn(Context->TreeNewHandle, PH_THREAD_STACKS_COLUMN_THREADID, TRUE, PhGetApplicationUiString(IDS_PH_TREENEW_TID), 80, PH_ALIGN_LEFT, 2, 0);
    PhAddTreeNewColumn(Context->TreeNewHandle, PH_THREAD_STACKS_COLUMN_FRAMENUMBER, TRUE, PhGetApplicationUiString(IDS_PH_TREENEW_FRAME), 80, PH_ALIGN_LEFT, 3, 0);
    PhAddTreeNewColumn(Context->TreeNewHandle, PH_THREAD_STACKS_COLUMN_ARCHITECTURE, TRUE, PhGetApplicationUiString(IDS_PH_TREENEW_ARCHITECTURE), 100, PH_ALIGN_LEFT, 4, 0);

    PhAddTreeNewColumn(Context->TreeNewHandle, PH_THREAD_STACKS_COLUMN_STACKADDRESS, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_STACK_ADDRESS), 100, PH_ALIGN_LEFT, ULONG_MAX, 0);
    PhAddTreeNewColumn(Context->TreeNewHandle, PH_THREAD_STACKS_COLUMN_FRAMEADDRESS, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_FRAME_ADDRESS), 100, PH_ALIGN_LEFT, ULONG_MAX, 0);
    PhAddTreeNewColumn(Context->TreeNewHandle, PH_THREAD_STACKS_COLUMN_PARAMETER1, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_STACK_PARAMETER_1), 100, PH_ALIGN_LEFT, ULONG_MAX, 0);
    PhAddTreeNewColumn(Context->TreeNewHandle, PH_THREAD_STACKS_COLUMN_PARAMETER2, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_STACK_PARAMETER_2), 100, PH_ALIGN_LEFT, ULONG_MAX, 0);
    PhAddTreeNewColumn(Context->TreeNewHandle, PH_THREAD_STACKS_COLUMN_PARAMETER3, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_STACK_PARAMETER_3), 100, PH_ALIGN_LEFT, ULONG_MAX, 0);
    PhAddTreeNewColumn(Context->TreeNewHandle, PH_THREAD_STACKS_COLUMN_PARAMETER4, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_STACK_PARAMETER_4), 100, PH_ALIGN_LEFT, ULONG_MAX, 0);
    PhAddTreeNewColumn(Context->TreeNewHandle, PH_THREAD_STACKS_COLUMN_CONTROLADDRESS, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_CONTROL_ADDRESS), 100, PH_ALIGN_LEFT, ULONG_MAX, 0);
    PhAddTreeNewColumn(Context->TreeNewHandle, PH_THREAD_STACKS_COLUMN_RETURNADDRESS, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_RETURN_ADDRESS), 100, PH_ALIGN_LEFT, ULONG_MAX, 0);
    ...
    PhAddTreeNewColumn(Context->TreeNewHandle, PH_THREAD_STACKS_COLUMN_LINETEXT, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_LINE_NUMBER), 100, PH_ALIGN_LEFT, ULONG_MAX, 0);
    PhAddTreeNewColumn(Context->TreeNewHandle, PH_THREAD_STACKS_COLUMN_FRAMEDISTANCE, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_FRAME_DISTANCE), 100, PH_ALIGN_LEFT, ULONG_MAX, 0);
    PhAddTreeNewColumn(Context->TreeNewHandle, PH_THREAD_STACKS_COLUMN_STARTADDRESS, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_START_ADDRESS), 100, PH_ALIGN_LEFT, ULONG_MAX, 0);
    PhAddTreeNewColumn(Context->TreeNewHandle, PH_THREAD_STACKS_COLUMN_STARTADDRESSSYMBOL, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_START_ADDRESS_SYMBOLIC), 100, PH_ALIGN_LEFT, ULONG_MAX, 0);
    PhAddTreeNewColumn(Context->TreeNewHandle, PH_THREAD_STACKS_COLUMN_PROCESSNAME, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_PROCESS_NAME), 250, PH_ALIGN_LEFT, ULONG_MAX, 0);
    PhAddTreeNewColumn(Context->TreeNewHandle, PH_THREAD_STACKS_COLUMN_THREADNAME, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_THREAD_NAME), 250, PH_ALIGN_LEFT, ULONG_MAX, 0);
