...
typedef PPH_MINIINFO_LIST_SECTION (NTAPI *PPH_MINIINFO_CREATE_LIST_SECTION2)(
    _In_ PCWSTR Name,
...
typedef struct _PH_PLUGIN_MINIINFO_POINTERS
{
    ...
    PPH_MINIINFO_CREATE_LIST_SECTION2 CreateListSection2;
...
typedef _Function_class_(PH_OPTIONS_CREATE_SECTION2)
PPH_OPTIONS_SECTION NTAPI PH_OPTIONS_CREATE_SECTION2(
    _In_ PCWSTR Name,
    _In_ PVOID Instance,
...
typedef PH_OPTIONS_CREATE_SECTION2 *PPH_OPTIONS_CREATE_SECTION2;
...
typedef struct _PH_PLUGIN_OPTIONS_POINTERS
{
    ...
    PPH_OPTIONS_CREATE_SECTION2 CreateSection2;
