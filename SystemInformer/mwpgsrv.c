    ...
    case MainTabPageInitializeSectionMenuItems:
        {
            ...
            menu = PhCreateEMenuItem(0, 0, PhGetApplicationUiString(IDS_PH_GROUP_SERVICES), NULL, NULL);
            PhInsertEMenuItem(menuInfo->Menu, menu, menuInfo->StartIndex);

            PhInsertEMenuItem(menu, PhCreateEMenuItem(0, ID_VIEW_HIDEMICROSOFTSERVICES, PhGetApplicationUiString(IDS_PH_MENU_HIDE_DEFAULT_SERVICES), NULL, NULL), ULONG_MAX);
            PhInsertEMenuItem(menu, PhCreateEMenuItem(0, ID_VIEW_HIDEDRIVERSERVICES, PhGetApplicationUiString(IDS_PH_MENU_HIDE_DRIVER_SERVICES), NULL, NULL), ULONG_MAX);
    ...
    )
{
    ...
    if (numberOfServices != 0)
    {
        ...
        menu = PhCreateEMenu();
        PhInsertEMenuItem(menu, PhCreateEMenuItem(0, ID_SERVICE_START, PhGetApplicationUiString(IDS_PH_SERVICE_START), NULL, NULL), ULONG_MAX);
        PhInsertEMenuItem(menu, PhCreateEMenuItem(0, ID_SERVICE_CONTINUE, PhGetApplicationUiString(IDS_PH_SERVICE_CONTINUE), NULL, NULL), ULONG_MAX);
        PhInsertEMenuItem(menu, PhCreateEMenuItem(0, ID_SERVICE_PAUSE, PhGetApplicationUiString(IDS_PH_SERVICE_PAUSE), NULL, NULL), ULONG_MAX);
        PhInsertEMenuItem(menu, PhCreateEMenuItem(0, ID_SERVICE_STOP, PhGetApplicationUiString(IDS_PH_SERVICE_STOP), NULL, NULL), ULONG_MAX);
        PhInsertEMenuItem(menu, PhCreateEMenuItem(0, ID_SERVICE_DELETE, PhGetApplicationUiString(IDS_PH_MENU_DELETE_SHORTCUT), NULL, NULL), ULONG_MAX);
        PhInsertEMenuItem(menu, PhCreateEMenuSeparator(), ULONG_MAX);
        PhInsertEMenuItem(menu, PhCreateEMenuItem(0, ID_SERVICE_GOTOPROCESS, PhGetApplicationUiString(IDS_PH_MENU_GO_TO_PROCESS), NULL, NULL), ULONG_MAX);
        PhInsertEMenuItem(menu, PhCreateEMenuSeparator(), ULONG_MAX);
        PhInsertEMenuItem(menu, PhCreateEMenuItem(0, ID_SERVICE_OPENKEY, PhGetApplicationUiString(IDS_PH_MENU_OPEN_KEY), NULL, NULL), ULONG_MAX);
        PhInsertEMenuItem(menu, PhCreateEMenuItem(0, ID_SERVICE_OPENFILELOCATION, PhGetApplicationUiString(IDS_PH_MENU_OPEN_FILE_LOCATION_SHORTCUT), NULL, NULL), ULONG_MAX);
        PhInsertEMenuItem(menu, PhCreateEMenuItem(0, ID_SERVICE_PROPERTIES, PhGetApplicationUiString(IDS_PH_MENU_PROPERTIES_SHORTCUT), NULL, NULL), ULONG_MAX);
        PhInsertEMenuItem(menu, PhCreateEMenuSeparator(), ULONG_MAX);
        PhInsertEMenuItem(menu, PhCreateEMenuItem(0, ID_SERVICE_COPY, PhGetApplicationUiString(IDS_PH_MENU_COPY_SHORTCUT), NULL, NULL), ULONG_MAX);
