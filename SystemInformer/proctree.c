    ...
    )
{
    ...
    // Default columns
    PhAddTreeNewColumn(hwnd, PHPRTLC_NAME, TRUE, PhGetApplicationUiString(IDS_PH_TOKEN_NAME), 200, PH_ALIGN_LEFT, (PhGetIntegerSetting(SETTING_PROCESS_TREE_LIST_NAME_DEFAULT) ? TN_COLUMN_FIXED : 0), 0); // HACK (dmex)
    PhAddTreeNewColumn(hwnd, PHPRTLC_PID, TRUE, PhGetApplicationUiString(IDS_PH_PID), 50, PH_ALIGN_RIGHT, 0, DT_RIGHT);
    PhAddTreeNewColumnEx(hwnd, PHPRTLC_CPU, TRUE, PhGetApplicationUiString(IDS_PH_STAT_CPU), 45, PH_ALIGN_RIGHT, 1, DT_RIGHT, TRUE);
    PhAddTreeNewColumnEx(hwnd, PHPRTLC_IOTOTALRATE, TRUE, PhGetApplicationUiString(IDS_PH_TREENEW_IO_TOTAL_RATE), 70, PH_ALIGN_RIGHT, 2, DT_RIGHT, TRUE);
    PhAddTreeNewColumnEx(hwnd, PHPRTLC_PRIVATEBYTES, TRUE, PhGetApplicationUiString(IDS_PH_STAT_PRIVATEBYTES), 70, PH_ALIGN_RIGHT, 3, DT_RIGHT, TRUE);
    PhAddTreeNewColumn(hwnd, PHPRTLC_USERNAME, TRUE, PhGetApplicationUiString(IDS_PH_SESSION_USER_NAME), 140, PH_ALIGN_LEFT, 4, DT_PATH_ELLIPSIS);
    PhAddTreeNewColumn(hwnd, PHPRTLC_DESCRIPTION, TRUE, PhGetApplicationUiString(IDS_PH_LISTVIEW_DESCRIPTION), 180, PH_ALIGN_LEFT, 5, 0);

    // Customizable columns (1)
    PhAddTreeNewColumn(hwnd, PHPRTLC_COMPANYNAME, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_COMPANY_NAME), 180, PH_ALIGN_LEFT, ULONG_MAX, 0);
    PhAddTreeNewColumn(hwnd, PHPRTLC_VERSION, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_VERSION), 100, PH_ALIGN_LEFT, ULONG_MAX, 0);
    PhAddTreeNewColumn(hwnd, PHPRTLC_FILENAME, FALSE, PhGetApplicationUiString(IDS_PH_FILE_NAME), 180, PH_ALIGN_LEFT, ULONG_MAX, DT_PATH_ELLIPSIS);
    PhAddTreeNewColumn(hwnd, PHPRTLC_COMMANDLINE, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_COMMAND_LINE), 180, PH_ALIGN_LEFT, ULONG_MAX, 0);
    PhAddTreeNewColumnEx(hwnd, PHPRTLC_PEAKPRIVATEBYTES, FALSE, PhGetApplicationUiString(IDS_PH_STAT_PEAKPRIVATEBYTES), 70, PH_ALIGN_RIGHT, ULONG_MAX, DT_RIGHT, TRUE);
    PhAddTreeNewColumnEx(hwnd, PHPRTLC_WORKINGSET, FALSE, PhGetApplicationUiString(IDS_PH_STAT_WORKINGSET), 70, PH_ALIGN_RIGHT, ULONG_MAX, DT_RIGHT, TRUE);
    PhAddTreeNewColumnEx(hwnd, PHPRTLC_PEAKWORKINGSET, FALSE, PhGetApplicationUiString(IDS_PH_STAT_PEAKWORKINGSET), 70, PH_ALIGN_RIGHT, ULONG_MAX, DT_RIGHT, TRUE);
    PhAddTreeNewColumnEx(hwnd, PHPRTLC_PRIVATEWS, FALSE, PhGetApplicationUiString(IDS_PH_STAT_PRIVATEWS), 70, PH_ALIGN_RIGHT, ULONG_MAX, DT_RIGHT, TRUE);
    PhAddTreeNewColumnEx(hwnd, PHPRTLC_SHAREDWS, FALSE, PhGetApplicationUiString(IDS_PH_STAT_SHAREDWS), 70, PH_ALIGN_RIGHT, ULONG_MAX, DT_RIGHT, TRUE);
    PhAddTreeNewColumnEx(hwnd, PHPRTLC_SHAREABLEWS, FALSE, PhGetApplicationUiString(IDS_PH_STAT_SHAREABLEWS), 70, PH_ALIGN_RIGHT, ULONG_MAX, DT_RIGHT, TRUE);
    PhAddTreeNewColumnEx(hwnd, PHPRTLC_VIRTUALSIZE, FALSE, PhGetApplicationUiString(IDS_PH_STAT_VIRTUALSIZE), 70, PH_ALIGN_RIGHT, ULONG_MAX, DT_RIGHT, TRUE);
    PhAddTreeNewColumnEx(hwnd, PHPRTLC_PEAKVIRTUALSIZE, FALSE, PhGetApplicationUiString(IDS_PH_STAT_PEAKVIRTUALSIZE), 70, PH_ALIGN_RIGHT, ULONG_MAX, DT_RIGHT, TRUE);
    PhAddTreeNewColumnEx(hwnd, PHPRTLC_PAGEFAULTS, FALSE, PhGetApplicationUiString(IDS_PH_STAT_PAGEFAULTS), 70, PH_ALIGN_RIGHT, ULONG_MAX, DT_RIGHT, TRUE);
    PhAddTreeNewColumn(hwnd, PHPRTLC_SESSIONID, FALSE, PhGetApplicationUiString(IDS_PH_SESSION_ID), 45, PH_ALIGN_RIGHT, ULONG_MAX, DT_RIGHT);
    PhAddTreeNewColumnEx(hwnd, PHPRTLC_PRIORITYCLASS, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_PRIORITY_CLASS), 100, PH_ALIGN_LEFT, ULONG_MAX, 0, TRUE);
    PhAddTreeNewColumnEx(hwnd, PHPRTLC_BASEPRIORITY, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_BASE_PRIORITY), 45, PH_ALIGN_RIGHT, ULONG_MAX, DT_RIGHT, TRUE);

    // Customizable columns (2)
    PhAddTreeNewColumnEx(hwnd, PHPRTLC_THREADS, FALSE, PhGetApplicationUiString(IDS_PH_GROUP_THREADS), 45, PH_ALIGN_RIGHT, ULONG_MAX, DT_RIGHT, TRUE);
    PhAddTreeNewColumnEx(hwnd, PHPRTLC_HANDLES, FALSE, PhGetApplicationUiString(IDS_PH_STAT_HANDLES), 45, PH_ALIGN_RIGHT, ULONG_MAX, DT_RIGHT, TRUE);
    PhAddTreeNewColumnEx(hwnd, PHPRTLC_GDIHANDLES, FALSE, PhGetApplicationUiString(IDS_PH_STAT_GDIHANDLES), 45, PH_ALIGN_RIGHT, ULONG_MAX, DT_RIGHT, TRUE);
    PhAddTreeNewColumnEx(hwnd, PHPRTLC_USERHANDLES, FALSE, PhGetApplicationUiString(IDS_PH_STAT_USERHANDLES), 45, PH_ALIGN_RIGHT, ULONG_MAX, DT_RIGHT, TRUE);
    PhAddTreeNewColumnEx(hwnd, PHPRTLC_IORORATE, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_IO_READ_OTHER_RATE), 70, PH_ALIGN_RIGHT, ULONG_MAX, DT_RIGHT, TRUE);
    PhAddTreeNewColumnEx(hwnd, PHPRTLC_IOWRATE, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_IO_WRITE_RATE), 70, PH_ALIGN_RIGHT, ULONG_MAX, DT_RIGHT, TRUE);
    PhAddTreeNewColumn(hwnd, PHPRTLC_INTEGRITY, FALSE, PhGetApplicationUiString(IDS_PH_HANDLE_SECURITY_INTEGRITY), 100, PH_ALIGN_LEFT, ULONG_MAX, 0);
    PhAddTreeNewColumnEx(hwnd, PHPRTLC_IOPRIORITY, FALSE, PhGetApplicationUiString(IDS_PH_STAT_IOPRIORITY), 70, PH_ALIGN_LEFT, ULONG_MAX, 0, TRUE);
    PhAddTreeNewColumnEx(hwnd, PHPRTLC_PAGEPRIORITY, FALSE, PhGetApplicationUiString(IDS_PH_STAT_PAGEPRIORITY), 45, PH_ALIGN_RIGHT, ULONG_MAX, DT_RIGHT, TRUE);
    PhAddTreeNewColumnEx(hwnd, PHPRTLC_STARTTIME, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_START_TIME), 100, PH_ALIGN_LEFT, ULONG_MAX, 0, TRUE);
    PhAddTreeNewColumnEx(hwnd, PHPRTLC_TOTALCPUTIME, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_TOTAL_CPU_TIME), 90, PH_ALIGN_RIGHT, ULONG_MAX, DT_RIGHT, TRUE);
    PhAddTreeNewColumnEx(hwnd, PHPRTLC_KERNELCPUTIME, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_KERNEL_CPU_TIME), 90, PH_ALIGN_RIGHT, ULONG_MAX, DT_RIGHT, TRUE);
    PhAddTreeNewColumnEx(hwnd, PHPRTLC_USERCPUTIME, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_USER_CPU_TIME), 90, PH_ALIGN_RIGHT, ULONG_MAX, DT_RIGHT, TRUE);
    PhAddTreeNewColumn(hwnd, PHPRTLC_VERIFICATIONSTATUS, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_VERIFICATION_STATUS), 70, PH_ALIGN_LEFT, ULONG_MAX, 0);
    PhAddTreeNewColumn(hwnd, PHPRTLC_VERIFIEDSIGNER, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_VERIFIED_SIGNER), 100, PH_ALIGN_LEFT, ULONG_MAX, 0);
    PhAddTreeNewColumnEx(hwnd, PHPRTLC_ASLR, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_ASLR), 50, PH_ALIGN_LEFT, ULONG_MAX, 0, TRUE);
    PhAddTreeNewColumn(hwnd, PHPRTLC_RELATIVESTARTTIME, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_RELATIVE_START_TIME), 180, PH_ALIGN_LEFT, ULONG_MAX, 0);
    PhAddTreeNewColumn(hwnd, PHPRTLC_BITS, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_BITS), 50, PH_ALIGN_LEFT, ULONG_MAX, 0);
    PhAddTreeNewColumnEx(hwnd, PHPRTLC_ELEVATION, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_ELEVATION), 60, PH_ALIGN_LEFT, ULONG_MAX, 0, TRUE);
    PhAddTreeNewColumn(hwnd, PHPRTLC_WINDOWTITLE, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_WINDOW_TITLE), 120, PH_ALIGN_LEFT, ULONG_MAX, 0);
    PhAddTreeNewColumnEx(hwnd, PHPRTLC_WINDOWSTATUS, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_WINDOW_STATUS), 60, PH_ALIGN_LEFT, ULONG_MAX, 0, TRUE);
    PhAddTreeNewColumnEx(hwnd, PHPRTLC_CYCLES, FALSE, PhGetApplicationUiString(IDS_PH_STAT_CYCLES), 110, PH_ALIGN_RIGHT, ULONG_MAX, DT_RIGHT, TRUE);
    PhAddTreeNewColumnEx(hwnd, PHPRTLC_CYCLESDELTA, FALSE, PhGetApplicationUiString(IDS_PH_STAT_CYCLESDELTA), 90, PH_ALIGN_RIGHT, ULONG_MAX, DT_RIGHT, TRUE);
    PhAddTreeNewColumnEx2(hwnd, PHPRTLC_CPUHISTORY, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_CPU_HISTORY), 100, PH_ALIGN_LEFT, ULONG_MAX, 0, TN_COLUMN_FLAG_CUSTOMDRAW | TN_COLUMN_FLAG_SORTDESCENDING);
    PhAddTreeNewColumnEx2(hwnd, PHPRTLC_PRIVATEBYTESHISTORY, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_PRIVATE_BYTES_HISTORY), 100, PH_ALIGN_LEFT, ULONG_MAX, 0, TN_COLUMN_FLAG_CUSTOMDRAW | TN_COLUMN_FLAG_SORTDESCENDING);
    PhAddTreeNewColumnEx2(hwnd, PHPRTLC_IOHISTORY, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_IO_HISTORY), 100, PH_ALIGN_LEFT, ULONG_MAX, 0, TN_COLUMN_FLAG_CUSTOMDRAW | TN_COLUMN_FLAG_SORTDESCENDING);
    PhAddTreeNewColumn(hwnd, PHPRTLC_DEP, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_DEP), 100, PH_ALIGN_LEFT, ULONG_MAX, 0);
    PhAddTreeNewColumnEx(hwnd, PHPRTLC_VIRTUALIZED, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_VIRTUALIZED), 80, PH_ALIGN_LEFT, ULONG_MAX, 0, TRUE);
    PhAddTreeNewColumnEx(hwnd, PHPRTLC_CONTEXTSWITCHES, FALSE, PhGetApplicationUiString(IDS_PH_STAT_CONTEXTSWITCHES), 100, PH_ALIGN_RIGHT, ULONG_MAX, DT_RIGHT, TRUE);
    PhAddTreeNewColumnEx(hwnd, PHPRTLC_CONTEXTSWITCHESDELTA, FALSE, PhGetApplicationUiString(IDS_PH_STAT_CONTEXTSWITCHESDELTA), 80, PH_ALIGN_RIGHT, ULONG_MAX, DT_RIGHT, TRUE);
    PhAddTreeNewColumnEx(hwnd, PHPRTLC_PAGEFAULTSDELTA, FALSE, PhGetApplicationUiString(IDS_PH_STAT_PAGEFAULTSDELTA), 70, PH_ALIGN_RIGHT, ULONG_MAX, DT_RIGHT, TRUE);

    // I/O group columns
    PhAddTreeNewColumnEx(hwnd, PHPRTLC_IOREADS, FALSE, PhGetApplicationUiString(IDS_PH_STAT_IOREADS), 70, PH_ALIGN_RIGHT, ULONG_MAX, DT_RIGHT, TRUE);
    PhAddTreeNewColumnEx(hwnd, PHPRTLC_IOWRITES, FALSE, PhGetApplicationUiString(IDS_PH_STAT_IOWRITES), 70, PH_ALIGN_RIGHT, ULONG_MAX, DT_RIGHT, TRUE);
    PhAddTreeNewColumnEx(hwnd, PHPRTLC_IOOTHER, FALSE, PhGetApplicationUiString(IDS_PH_STAT_IOOTHER), 70, PH_ALIGN_RIGHT, ULONG_MAX, DT_RIGHT, TRUE);
    PhAddTreeNewColumnEx(hwnd, PHPRTLC_IOREADBYTES, FALSE, PhGetApplicationUiString(IDS_PH_STAT_IOREADBYTES), 70, PH_ALIGN_RIGHT, ULONG_MAX, DT_RIGHT, TRUE);
    PhAddTreeNewColumnEx(hwnd, PHPRTLC_IOWRITEBYTES, FALSE, PhGetApplicationUiString(IDS_PH_STAT_IOWRITEBYTES), 70, PH_ALIGN_RIGHT, ULONG_MAX, DT_RIGHT, TRUE);
    PhAddTreeNewColumnEx(hwnd, PHPRTLC_IOOTHERBYTES, FALSE, PhGetApplicationUiString(IDS_PH_STAT_IOOTHERBYTES), 70, PH_ALIGN_RIGHT, ULONG_MAX, DT_RIGHT, TRUE);
    PhAddTreeNewColumnEx(hwnd, PHPRTLC_IOREADSDELTA, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_IO_READS_DELTA), 70, PH_ALIGN_RIGHT, ULONG_MAX, DT_RIGHT, TRUE);
    PhAddTreeNewColumnEx(hwnd, PHPRTLC_IOWRITESDELTA, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_IO_WRITES_DELTA), 70, PH_ALIGN_RIGHT, ULONG_MAX, DT_RIGHT, TRUE);
    PhAddTreeNewColumnEx(hwnd, PHPRTLC_IOOTHERDELTA, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_IO_OTHER_DELTA), 70, PH_ALIGN_RIGHT, ULONG_MAX, DT_RIGHT, TRUE);

    // Customizable columns (3)
    PhAddTreeNewColumn(hwnd, PHPRTLC_OSCONTEXT, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_OS_CONTEXT), 100, PH_ALIGN_LEFT, ULONG_MAX, 0);
    PhAddTreeNewColumnEx(hwnd, PHPRTLC_PAGEDPOOL, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_PAGED_POOL), 70, PH_ALIGN_RIGHT, ULONG_MAX, DT_RIGHT, TRUE);
    PhAddTreeNewColumnEx(hwnd, PHPRTLC_PEAKPAGEDPOOL, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_PEAK_PAGED_POOL), 70, PH_ALIGN_RIGHT, ULONG_MAX, DT_RIGHT, TRUE);
    PhAddTreeNewColumnEx(hwnd, PHPRTLC_NONPAGEDPOOL, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_NON_PAGED_POOL), 70, PH_ALIGN_RIGHT, ULONG_MAX, DT_RIGHT, TRUE);
    PhAddTreeNewColumnEx(hwnd, PHPRTLC_PEAKNONPAGEDPOOL, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_PEAK_NON_PAGED_POOL), 70, PH_ALIGN_RIGHT, ULONG_MAX, DT_RIGHT, TRUE);
    PhAddTreeNewColumnEx(hwnd, PHPRTLC_MINIMUMWORKINGSET, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_MINIMUM_WORKING_SET), 70, PH_ALIGN_RIGHT, ULONG_MAX, DT_RIGHT, TRUE);
    PhAddTreeNewColumnEx(hwnd, PHPRTLC_MAXIMUMWORKINGSET, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_MAXIMUM_WORKING_SET), 70, PH_ALIGN_RIGHT, ULONG_MAX, DT_RIGHT, TRUE);
    PhAddTreeNewColumnEx(hwnd, PHPRTLC_PRIVATEBYTESDELTA, FALSE, PhGetApplicationUiString(IDS_PH_STAT_PRIVATEBYTESDELTA), 70, PH_ALIGN_RIGHT, ULONG_MAX, DT_RIGHT, TRUE);
    PhAddTreeNewColumn(hwnd, PHPRTLC_SUBSYSTEM, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_SUBSYSTEM), 110, PH_ALIGN_LEFT, ULONG_MAX, 0);
    PhAddTreeNewColumn(hwnd, PHPRTLC_PACKAGENAME, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_PACKAGE_NAME), 160, PH_ALIGN_LEFT, ULONG_MAX, 0);
    PhAddTreeNewColumn(hwnd, PHPRTLC_APPID, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_APP_ID), 160, PH_ALIGN_LEFT, ULONG_MAX, 0);
    PhAddTreeNewColumn(hwnd, PHPRTLC_DPIAWARENESS, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_DPI_AWARENESS), 110, PH_ALIGN_LEFT, ULONG_MAX, 0);
    PhAddTreeNewColumnEx(hwnd, PHPRTLC_CFGUARD, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_CF_GUARD), 70, PH_ALIGN_LEFT, ULONG_MAX, 0, TRUE);
    PhAddTreeNewColumnEx(hwnd, PHPRTLC_TIMESTAMP, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_TIME_STAMP), 140, PH_ALIGN_LEFT, ULONG_MAX, 0, TRUE);
    PhAddTreeNewColumnEx(hwnd, PHPRTLC_FILEMODIFIEDTIME, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_FILE_MODIFIED_TIME), 140, PH_ALIGN_LEFT, ULONG_MAX, 0, TRUE);
    PhAddTreeNewColumnEx(hwnd, PHPRTLC_FILESIZE, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_FILE_SIZE), 70, PH_ALIGN_RIGHT, ULONG_MAX, DT_RIGHT, TRUE);
    PhAddTreeNewColumnEx(hwnd, PHPRTLC_SUBPROCESSCOUNT, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_SUBPROCESSES), 70, PH_ALIGN_RIGHT, ULONG_MAX, DT_RIGHT, TRUE);
    PhAddTreeNewColumnEx(hwnd, PHPRTLC_JOBOBJECTID, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_JOB_OBJECT_ID), 50, PH_ALIGN_LEFT, ULONG_MAX, 0, TRUE);
    PhAddTreeNewColumnEx(hwnd, PHPRTLC_PROTECTION, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_PROTECTION), 105, PH_ALIGN_LEFT, ULONG_MAX, 0, TRUE);
    PhAddTreeNewColumnEx(hwnd, PHPRTLC_DESKTOP, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_DESKTOP), 80, PH_ALIGN_LEFT, ULONG_MAX, 0, TRUE);
    PhAddTreeNewColumnEx(hwnd, PHPRTLC_CRITICAL, FALSE, PhGetApplicationUiString(IDS_PH_MENU_THREAD_CRITICAL), 80, PH_ALIGN_LEFT, ULONG_MAX, 0, TRUE);
    PhAddTreeNewColumnEx(hwnd, PHPRTLC_PIDHEX, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_PID_HEX), 50, PH_ALIGN_RIGHT, ULONG_MAX, DT_RIGHT, TRUE);
    PhAddTreeNewColumnEx(hwnd, PHPRTLC_CPUCORECYCLES, FALSE, PhGetApplicationUiString(IDS_PH_STAT_CPURELATIVE), 45, PH_ALIGN_RIGHT, ULONG_MAX, DT_RIGHT, TRUE);
    PhAddTreeNewColumnEx(hwnd, PHPRTLC_CET, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_CET), 45, PH_ALIGN_LEFT, ULONG_MAX, 0, TRUE);
    PhAddTreeNewColumnEx(hwnd, PHPRTLC_IMAGE_COHERENCY, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_IMAGE_COHERENCY), 70, PH_ALIGN_RIGHT, ULONG_MAX, DT_RIGHT, TRUE);
    PhAddTreeNewColumnEx(hwnd, PHPRTLC_ERRORMODE, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_ERROR_MODE), 70, PH_ALIGN_LEFT, ULONG_MAX, 0, TRUE);
    PhAddTreeNewColumnEx(hwnd, PHPRTLC_CODEPAGE, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_CODE_PAGE), 70, PH_ALIGN_LEFT, ULONG_MAX, 0, TRUE);
    PhAddTreeNewColumnEx2(hwnd, PHPRTLC_TIMELINE, FALSE, PhGetApplicationUiString(IDS_PH_TIMELINE), 100, PH_ALIGN_LEFT, ULONG_MAX, 0, TN_COLUMN_FLAG_CUSTOMDRAW | TN_COLUMN_FLAG_SORTDESCENDING);
    PhAddTreeNewColumnEx(hwnd, PHPRTLC_POWERTHROTTLING, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_POWER_THROTTLING), 70, PH_ALIGN_LEFT, ULONG_MAX, 0, TRUE);
    PhAddTreeNewColumnEx(hwnd, PHPRTLC_ARCHITECTURE, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_ARCHITECTURE), 70, PH_ALIGN_LEFT, ULONG_MAX, 0, TRUE);
    PhAddTreeNewColumn(hwnd, PHPRTLC_PARENTPID, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_PARENT_PID), 50, PH_ALIGN_RIGHT, ULONG_MAX, DT_RIGHT);
    PhAddTreeNewColumn(hwnd, PHPRTLC_PARENTCONSOLEPID, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_PARENT_CONSOLE_PID), 50, PH_ALIGN_RIGHT, ULONG_MAX, DT_RIGHT);
    PhAddTreeNewColumnEx(hwnd, PHPRTLC_COMMITSIZE, FALSE, PhGetApplicationUiString(IDS_PH_STAT_SHAREDCOMMIT), 70, PH_ALIGN_RIGHT, ULONG_MAX, DT_RIGHT, TRUE);
    PhAddTreeNewColumnEx(hwnd, PHPRTLC_PRIORITYBOOST, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_PRIORITY_BOOST), 45, PH_ALIGN_LEFT, ULONG_MAX, 0, TRUE);
    PhAddTreeNewColumnEx(hwnd, PHPRTLC_CPUAVERAGE, FALSE, PhGetApplicationUiString(IDS_PH_STAT_CPUAVERAGE), 50, PH_ALIGN_RIGHT, ULONG_MAX, DT_RIGHT, TRUE);
    PhAddTreeNewColumnEx(hwnd, PHPRTLC_CPUKERNEL, FALSE, PhGetApplicationUiString(IDS_PH_STAT_CPUKERNEL), 50, PH_ALIGN_RIGHT, ULONG_MAX, DT_RIGHT, TRUE);
    PhAddTreeNewColumnEx(hwnd, PHPRTLC_CPUUSER, FALSE, PhGetApplicationUiString(IDS_PH_STAT_CPUUSER), 50, PH_ALIGN_LEFT, ULONG_MAX, DT_RIGHT, TRUE);
    PhAddTreeNewColumn(hwnd, PHPRTLC_GRANTEDACCESS, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_GRANTED_ACCESS_SYMBOLIC), 50, PH_ALIGN_LEFT, ULONG_MAX, 0);
    PhAddTreeNewColumn(hwnd, PHPRTLC_TLSBITMAPDELTA, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_THREAD_LOCAL_STORAGE), 50, PH_ALIGN_LEFT, ULONG_MAX, 0);
    PhAddTreeNewColumnEx(hwnd, PHPRTLC_REFERENCEDELTA, FALSE, PhGetApplicationUiString(IDS_PH_GROUP_REFERENCES), 50, PH_ALIGN_RIGHT, ULONG_MAX, DT_RIGHT, TRUE);
    PhAddTreeNewColumn(hwnd, PHPRTLC_LXSSPID, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_PID_LXSS), 50, PH_ALIGN_LEFT, ULONG_MAX, 0);
    PhAddTreeNewColumn(hwnd, PHPRTLC_START_KEY, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_START_KEY), 120, PH_ALIGN_LEFT, ULONG_MAX, 0);
    PhAddTreeNewColumn(hwnd, PHPRTLC_MITIGATION_POLICIES, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_MITIGATION_POLICIES), 180, PH_ALIGN_LEFT, ULONG_MAX, 0);
    PhAddTreeNewColumn(hwnd, PHPRTLC_SERVICES, FALSE, PhGetApplicationUiString(IDS_PH_GROUP_SERVICES), 180, PH_ALIGN_LEFT, ULONG_MAX, 0);
    PhAddTreeNewColumn(hwnd, PHPRTLC_SHORT_USERNAME, FALSE, PhGetApplicationUiString(IDS_PH_TREENEW_SHORT_USER_NAME), 140, PH_ALIGN_LEFT, ULONG_MAX, 0);
