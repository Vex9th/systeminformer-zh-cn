...
class NativeResourceGenerationTests(unittest.TestCase):
    ...
    def test_main_tray_notification_items_use_native_resources(self) -> None:
        ...
        self.assertRegex(
            resource_header,
            r"(?m)^#define\s+IDS_PH_LAST\s+IDS_PH_UNKNOWN_PROCESS_FORMAT$",
        )
        self.assertRegex(
            resource_header,
            r"(?m)^#define\s+_APS_NEXT_SYMED_VALUE\s+2560$",
        )
    ...
    def test_all_generated_resources_are_current(self) -> None:
        ...
        self.assertIn("1638 strings", result.stdout)
    ...
    def test_main_options_messages_use_native_string_resources(self) -> None:
        ...
        self.assertEqual(len(stringtable_ids(resource_script)), 560)
        self.assertIn(
        ...
        self.assertEqual(sorted(numeric_ids), list(range(2000, 2560)))
    ...
    def test_extended_tools_adapter_details_share_native_resources(self) -> None:
        ...
        self.assertRegex(
            resource_header,
            r"(?m)^#define\s+_APS_NEXT_SYMED_VALUE\s+61200$",
        )
    ...
    def test_ci_validates_all_built_plugin_resources(self) -> None:
        ...
        self.assertEqual(
            ...
            Counter(
                {
                    (r"bin\Release64\sys_info.exe", 560): 2,
                    ...
                    (r"bin\Release64\plugins\WindowExplorer.dll", 110): 2,
