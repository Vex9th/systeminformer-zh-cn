...
class NativeResourceGenerationTests(unittest.TestCase):
    ...
    def test_main_tray_notification_items_use_native_resources(self) -> None:
        ...
        self.assertRegex(
            resource_header,
            r"(?m)^#define\s+IDS_PH_LAST\s+IDS_PH_CONFIRM_EXECUTION_REQUIRED_WARNING$",
        )
        self.assertRegex(
            resource_header,
            r"(?m)^#define\s+_APS_NEXT_SYMED_VALUE\s+2984$",
        )
    ...
    def test_all_generated_resources_are_current(self) -> None:
        ...
        self.assertIn("2624 strings", result.stdout)
    ...
    def test_main_options_messages_use_native_string_resources(self) -> None:
        ...
        self.assertEqual(len(stringtable_ids(resource_script)), 984)
        self.assertIn(
    ...
    def test_main_combo_and_service_labels_use_native_resources(self) -> None:
        ...
        expected_routes = {
            ...
            "IDS_PH_LOGON_NETWORK": ("Network", 2),
        ...
        for resource_id, (english_text, expected_count) in expected_routes.items():
            with self.subTest(main_native_label=resource_id):
                ...
                if resource_id in item_data_resource_ids:
                    self.assertEqual(source.count(resource_id), expected_count)
                else:
                    self.assertEqual(
                        source.count(
    ...
    def test_final_main_and_phlib_errors_use_native_resources(self) -> None:
        ...
        expected_ids = {
            ...
            "IDS_PH_ACTION_TERMINATE": 6,
            "IDS_PH_ACTION_SUSPEND": 5,
            "IDS_PH_ACTION_RESUME": 5,
            "IDS_PH_ACTION_FREEZE": 2,
            "IDS_PH_ACTION_THAW": 1,
            "IDS_PH_ACTION_RESTART": 14,
            ...
            "IDS_PH_ACTION_CLOSE_HANDLE": 4,
            "IDS_PH_ACTION_SET_HANDLE_ATTRIBUTES": 1,
            "IDS_PH_PROCESS_PAIR_FORMAT": 1,
            "IDS_PH_PROCESS_AND_DESCENDANTS_FORMAT": 3,
            "IDS_PH_ACTION_CHANGE_EXECUTION_REQUIRED": 1,
            "IDS_PH_EXECUTION_REQUIRED_ACTION_FORMAT": 1,
        }
        ...
        for path in (REPO_ROOT / "SystemInformer").glob("*.c"):
            ...
            for name, args, spans, call_start in audit.find_calls(
                ...
                if len(args) <= 1:
                    continue
                message = args[1]
                startup_resource_message = (
                    path.name == "main.c"
                    and message.strip() == "resourceTitle->Buffer"
                    and re.search(
                ...
                if (
                    ...
                    and not startup_resource_message
                ):
                    unresolved.append(
    ...
    def test_ci_validates_all_built_plugin_resources(self) -> None:
        ...
        self.assertEqual(
            ...
            Counter(
                {
                    (r"bin\Release64\sys_info.exe", 984): 2,
