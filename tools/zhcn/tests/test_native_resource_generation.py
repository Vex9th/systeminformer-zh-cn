...
class NativeResourceGenerationTests(unittest.TestCase):
    ...
    def test_all_generated_resources_are_current(self) -> None:
        ...
        self.assertIn("1496 strings", result.stdout)
    ...
    def test_peview_context_menus_use_native_string_resources(self) -> None:
        ...
        self.assertEqual(len(stringtable_ids(resource_script)), 278)
    ...
    def test_peview_hash_groups_use_native_string_resources(self) -> None:
        ...
        self.assertRegex(
            resource_header,
            r"(?m)^#define\s+IDS_PV_LAST\s+IDS_PV_MACHINE_ARM64_ARM64X$",
        )
        self.assertRegex(
            resource_header,
            r"(?m)^#define\s+_APS_NEXT_SYMED_VALUE\s+3278$",
        )
        self.assertEqual(len(stringtable_ids(english_rc)), 278)
        self.assertEqual(len(stringtable_ids(chinese_rc)), 278)
            ...
            Counter(
                {
                    ...
                    (r"bin\Release64\peview.exe", 278): 2,
