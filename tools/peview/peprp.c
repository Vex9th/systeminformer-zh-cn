    ...
    case WM_INITDIALOG:
        {
            ...
            PhAddListViewColumn(context->ListViewHandle, 0, 0, 0, LVCFMT_LEFT, 150, PvpLoadUiString(IDS_PV_COLUMN_NAME));
            PhAddListViewColumn(context->ListViewHandle, 1, 1, 1, LVCFMT_LEFT, 300, PvpLoadUiString(IDS_PV_COLUMN_VALUE));
