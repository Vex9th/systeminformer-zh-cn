    ...
    case WM_INITDIALOG:
        {
            ...
            PhAddListViewColumn(context->ListViewHandle, 5, 5, 5, LVCFMT_LEFT, 100, PvpLoadUiString(IDS_PV_COLUMN_SECTION));
            PhAddListViewColumn(context->ListViewHandle, 6, 6, 6, LVCFMT_LEFT, 80, PvpLoadUiString(IDS_PV_COLUMN_HASH));
            PhAddListViewColumn(context->ListViewHandle, 7, 7, 7, LVCFMT_LEFT, 100, PvpLoadUiString(IDS_PV_COLUMN_ENTROPY));
            PhAddListViewColumn(context->ListViewHandle, 8, 8, 8, LVCFMT_LEFT, 80, PvpLoadUiString(IDS_PV_COLUMN_SSDEEP));
            PhAddListViewColumn(context->ListViewHandle, 9, 9, 9, LVCFMT_LEFT, 80, PvpLoadUiString(IDS_PV_COLUMN_TLSH));
