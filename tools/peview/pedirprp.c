    ...
    )
{
    ...
    PhAddTreeNewColumnEx2(TreeNewHandle, PV_DIRECTORY_TREE_COLUMN_ITEM_NAME, TRUE, PvpLoadUiString(IDS_PV_COLUMN_NAME), 130, PH_ALIGN_LEFT, PV_DIRECTORY_TREE_COLUMN_ITEM_NAME, 0, 0);
    PhAddTreeNewColumnEx2(TreeNewHandle, PV_DIRECTORY_TREE_COLUMN_ITEM_RAW_START, TRUE, PvpLoadUiString(IDS_PV_COLUMN_RAW_START), 100, PH_ALIGN_LEFT, PV_DIRECTORY_TREE_COLUMN_ITEM_RAW_START, 0, 0);
    PhAddTreeNewColumnEx2(TreeNewHandle, PV_DIRECTORY_TREE_COLUMN_ITEM_RAW_END, TRUE, PvpLoadUiString(IDS_PV_COLUMN_RAW_END), 100, PH_ALIGN_LEFT, PV_DIRECTORY_TREE_COLUMN_ITEM_RAW_END, 0, 0);
    PhAddTreeNewColumnEx2(TreeNewHandle, PV_DIRECTORY_TREE_COLUMN_ITEM_RVA_START, TRUE, PvpLoadUiString(IDS_PV_COLUMN_RVA_START), 100, PH_ALIGN_LEFT, PV_DIRECTORY_TREE_COLUMN_ITEM_RVA_START, 0, 0);
    PhAddTreeNewColumnEx2(TreeNewHandle, PV_DIRECTORY_TREE_COLUMN_ITEM_RVA_END, TRUE, PvpLoadUiString(IDS_PV_COLUMN_RVA_END), 100, PH_ALIGN_LEFT, PV_DIRECTORY_TREE_COLUMN_ITEM_RVA_END, 0, 0);
    PhAddTreeNewColumnEx2(TreeNewHandle, PV_DIRECTORY_TREE_COLUMN_ITEM_RVA_SIZE, TRUE, PvpLoadUiString(IDS_PV_COLUMN_SIZE), 80, PH_ALIGN_LEFT, PV_DIRECTORY_TREE_COLUMN_ITEM_RVA_SIZE, 0, 0);
    PhAddTreeNewColumnEx2(TreeNewHandle, PV_DIRECTORY_TREE_COLUMN_ITEM_SLACK_SIZE, TRUE, PvpLoadUiString(IDS_PV_COLUMN_SLACK_SPACE), 80, PH_ALIGN_LEFT, PV_DIRECTORY_TREE_COLUMN_ITEM_SLACK_SIZE, 0, 0);
    PhAddTreeNewColumnEx2(TreeNewHandle, PV_DIRECTORY_TREE_COLUMN_ITEM_SECTION, TRUE, PvpLoadUiString(IDS_PV_COLUMN_SECTION), 100, PH_ALIGN_LEFT, PV_DIRECTORY_TREE_COLUMN_ITEM_SECTION, 0, 0);
    PhAddTreeNewColumnEx2(TreeNewHandle, PV_DIRECTORY_TREE_COLUMN_ITEM_HASH, TRUE, PvpLoadUiString(IDS_PV_COLUMN_HASH), 80, PH_ALIGN_LEFT, PV_DIRECTORY_TREE_COLUMN_ITEM_HASH, 0, 0);
    PhAddTreeNewColumnEx2(TreeNewHandle, PV_DIRECTORY_TREE_COLUMN_ITEM_ENTROPY, TRUE, PvpLoadUiString(IDS_PV_COLUMN_ENTROPY), 80, PH_ALIGN_LEFT, PV_DIRECTORY_TREE_COLUMN_ITEM_ENTROPY, 0, 0);
    PhAddTreeNewColumnEx2(TreeNewHandle, PV_DIRECTORY_TREE_COLUMN_ITEM_SSDEEP, TRUE, PvpLoadUiString(IDS_PV_COLUMN_SSDEEP), 80, PH_ALIGN_LEFT, PV_DIRECTORY_TREE_COLUMN_ITEM_SSDEEP, 0, 0);
    PhAddTreeNewColumnEx2(TreeNewHandle, PV_DIRECTORY_TREE_COLUMN_ITEM_TLSH, TRUE, PvpLoadUiString(IDS_PV_COLUMN_TLSH), 80, PH_ALIGN_LEFT, PV_DIRECTORY_TREE_COLUMN_ITEM_TLSH, 0, 0);
