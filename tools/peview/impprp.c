    ...
    case WM_INITDIALOG:
        {
            ...
            TreeNew_SetEmptyText(context->TreeNewHandle, PvpLoadUiStringRef(IDS_PV_LOADING_IMPORTS), 0);
    ...
    case WM_PV_SEARCH_FINISHED:
        {
            ...
            TreeNew_SetEmptyText(context->TreeNewHandle, PvpLoadUiStringRef(IDS_PV_EMPTY_IMPORTS), 0);
    ...
    )
{
    ...
    PhAddTreeNewColumnEx2(TreeNewHandle, PV_IMPORT_TREE_COLUMN_ITEM_RVA, TRUE, PvpLoadUiString(IDS_PV_COLUMN_RVA), 80, PH_ALIGN_LEFT, PV_IMPORT_TREE_COLUMN_ITEM_RVA, 0, 0);
    PhAddTreeNewColumnEx2(TreeNewHandle, PV_IMPORT_TREE_COLUMN_ITEM_DLL, TRUE, PvpLoadUiString(IDS_PV_COLUMN_DLL), 80, PH_ALIGN_LEFT, PV_IMPORT_TREE_COLUMN_ITEM_DLL, 0, 0);
    PhAddTreeNewColumnEx2(TreeNewHandle, PV_IMPORT_TREE_COLUMN_ITEM_NAME, TRUE, PvpLoadUiString(IDS_PV_COLUMN_NAME), 250, PH_ALIGN_LEFT, PV_IMPORT_TREE_COLUMN_ITEM_NAME, 0, 0);
    PhAddTreeNewColumnEx2(TreeNewHandle, PV_IMPORT_TREE_COLUMN_ITEM_HINT, TRUE, PvpLoadUiString(IDS_PV_COLUMN_HINT), 50, PH_ALIGN_LEFT, PV_IMPORT_TREE_COLUMN_ITEM_HINT, 0, 0);
    PhAddTreeNewColumnEx2(TreeNewHandle, PV_IMPORT_TREE_COLUMN_ITEM_ORDINAL, TRUE, PvpLoadUiString(IDS_PV_COLUMN_ORDINAL), 80, PH_ALIGN_LEFT, PV_IMPORT_TREE_COLUMN_ITEM_ORDINAL, 0, 0);
    PhAddTreeNewColumnEx2(TreeNewHandle, PV_IMPORT_TREE_COLUMN_ITEM_ORDINALNAME, TRUE, PvpLoadUiString(IDS_PV_COLUMN_ORDINAL_NAME), 80, PH_ALIGN_LEFT, PV_IMPORT_TREE_COLUMN_ITEM_ORDINALNAME, 0, 0);
    PhAddTreeNewColumnEx2(TreeNewHandle, PV_IMPORT_TREE_COLUMN_ITEM_SYMBOL, TRUE, PvpLoadUiString(IDS_PV_COLUMN_UNDECORATED_NAME), 150, PH_ALIGN_LEFT, PV_IMPORT_TREE_COLUMN_ITEM_SYMBOL, 0, 0);
