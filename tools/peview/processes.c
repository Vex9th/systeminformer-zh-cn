    ...
    case WM_INITDIALOG:
        {
            ...
            PhAddListViewColumn(context->ListViewHandle, 1, 1, 1, LVCFMT_LEFT, 150, PvpLoadUiString(IDS_PV_COLUMN_PID));
            PhAddListViewColumn(context->ListViewHandle, 2, 2, 2, LVCFMT_LEFT, 150, PvpLoadUiString(IDS_PV_COLUMN_NAME));
