    ...
    case WM_INITDIALOG:
        {
            ...
            PhAddListViewColumn(context->ListViewHandle, 1, 1, 1, LVCFMT_LEFT, 250, PvpLoadUiString(IDS_PV_COLUMN_RVA));
            PhAddListViewColumn(context->ListViewHandle, 2, 2, 2, LVCFMT_LEFT, 100, PvpLoadUiString(IDS_PV_COLUMN_DLL));
            PhAddListViewColumn(context->ListViewHandle, 3, 3, 3, LVCFMT_LEFT, 250, PvpLoadUiString(IDS_PV_COLUMN_NAME));
            PhAddListViewColumn(context->ListViewHandle, 4, 4, 4, LVCFMT_LEFT, 80, PvpLoadUiString(IDS_PV_COLUMN_FLAGS));
